  ...
  return (
    <div className='w-full h-[80px] bg-white fixed top-0 shadow-lg flex justify-between md:justify-around items-center px-[10px] left-0 z-[80]'>
      ...
      <div className='flex justify-center items-center gap-[20px] relative'>
        ...
        <Link 
          to="/" 
          className={`flex flex-col items-center justify-center transition-colors p-2 rounded-lg min-w-[60px] ${
            isActivePath('/') ? 'text-black font-semibold border-b-2 border-blue-500' : 'text-gray-600 hover:text-black'
          }`}
        >
        ...
        <Link 
          to="/network" 
          className={`flex flex-col items-center justify-center transition-colors p-2 rounded-lg min-w-[60px] ${
            isActivePathStartsWith('/network') ? 'text-black font-semibold border-b-2 border-blue-500' : 'text-gray-600 hover:text-black'
          }`}
        >
        ...
        <Link 
          to="/jobs" 
          className={`flex flex-col items-center justify-center transition-colors p-2 rounded-lg min-w-[60px] ${
            isActivePathStartsWith('/jobs') ? 'text-black font-semibold border-b-2 border-blue-500' : 'text-gray-600 hover:text-black'
          }`}
        >
        ...
        <Link 
          to="/messages" 
          className={`flex flex-col items-center justify-center transition-colors p-2 rounded-lg min-w-[60px] ${
            isActivePathStartsWith('/messages') ? 'text-black font-semibold border-b-2 border-blue-500' : 'text-gray-600 hover:text-black'
          }`}
        >
        ...
        <Link 
          to="/notifications" 
          className={`flex flex-col items-center justify-center transition-colors p-2 rounded-lg min-w-[60px] relative ${
            isActivePath('/notifications') ? 'text-black font-semibold border-b-2 border-blue-500' : 'text-gray-600 hover:text-black'
          }`}
        >
        ...
        <div className='relative profile-avatar'>
          <div 
            className={`w-[45px] h-[45px] rounded-full overflow-hidden cursor-pointer border-2 transition-colors ${
              showPopup || isActivePathStartsWith('/profile') ? 'border-blue-500' : 'border-transparent hover:border-blue-500'
            }`}
